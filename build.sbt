...
lazy val mediator = project
  ...
  .settings(
    ...
    // Compile / unmanagedResourceDirectories += (baseDirectory.value.toPath.getParent.getParent / "serviceworker" / "target" / "scala-3.3.6" / "fmgp-serviceworker-fastopt").toFile,
