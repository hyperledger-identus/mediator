...
inThisBuild(
  Seq(
    scalaVersion := "3.3.5", // Also update docs/publishWebsite.sh and any ref to scala-3.3.3
...
lazy val mediator = project
  ...
  .settings(
    ...
    // Compile / unmanagedResourceDirectories += (baseDirectory.value.toPath.getParent.getParent / "serviceworker" / "target" / "scala-3.3.5" / "fmgp-serviceworker-fastopt").toFile,
