...
* **mediator:** Update the readme and docker with type of key forma… ([#267](https://github.com/hyperledger-identus/mediator/issues/267)) ([236620f](https://github.com/hyperledger-identus/mediator/commit/236620f8e8db2a9e07c4ee29c3cbb2411077f3b7))
...
* Update ScalaDID to 0.1.0-M18 and support new format of DID Peer ([#204](https://github.com/hyperledger-identus/mediator/issues/204)) ([26a1623](https://github.com/hyperledger-identus/mediator/commit/26a16230d7e7e68ccff92bc4f8fc1fd403254200)), closes [#158](https://github.com/hyperledger-identus/mediator/issues/158)
...
* Update timeout settings for websocket ([#191](https://github.com/hyperledger-identus/mediator/issues/191)) ([11a4437](https://github.com/hyperledger-identus/mediator/commit/11a44376664c55e97e18faa2b7f7849591b20532))
...
* Add and enable websocket on apisix route ([#179](https://github.com/hyperledger-identus/mediator/issues/179)) ([e5cfb1c](https://github.com/hyperledger-identus/mediator/commit/e5cfb1c0d5c284ab98ab36fef9e4bb81c97f3f53))
* correct endpoint for wss in deployment.yaml ([#178](https://github.com/hyperledger-identus/mediator/issues/178)) ([94866a9](https://github.com/hyperledger-identus/mediator/commit/94866a9077adf37761bd4b2218c280ef3bdc6e79))
...
* Return 202 HTTP code (for DID Comm) ([#162](https://github.com/hyperledger-identus/mediator/issues/162)) ([50185d3](https://github.com/hyperledger-identus/mediator/commit/50185d379d08949597479db8d8fd9d53526fd82a)), closes [#160](https://github.com/hyperledger-identus/mediator/issues/160)
* Support protocol discover-features 2.0 ([#154](https://github.com/hyperledger-identus/mediator/issues/154)) ([9220858](https://github.com/hyperledger-identus/mediator/commit/9220858111d992c099aff9e41cce90d7d06f0235))
...
* allowed memory to increase gradually in CI ([#37](https://github.com/hyperledger-identus/mediator/issues/37)) ([a73abbd](https://github.com/hyperledger-identus/mediator/commit/a73abbdaf248eb474489e858c8b22913c1ec42e1))
* Discord links to never expires ([#141](https://github.com/hyperledger-identus/mediator/issues/141)) ([e7f7a74](https://github.com/hyperledger-identus/mediator/commit/e7f7a74237d5a79ab3fe39ff4f82712e1ed49163))
* **infra:** add sync-wave to certificate template ([#134](https://github.com/hyperledger-identus/mediator/issues/134)) ([82f902f](https://github.com/hyperledger-identus/mediator/commit/82f902f625246f0c1d0e06db096022e024c879c0))
* MissingProtocolExecuter ([#140](https://github.com/hyperledger-identus/mediator/issues/140)) ([c7a0f90](https://github.com/hyperledger-identus/mediator/commit/c7a0f90a094a5b075df9569a38f8f36681a25b2c))
* OutOfBand qrcode with base url ([#133](https://github.com/hyperledger-identus/mediator/issues/133)) ([56d34f9](https://github.com/hyperledger-identus/mediator/commit/56d34f9ebfee74b71a644b35761861fe49515861))
* send status message on delivery request If no messages are avail… ([#139](https://github.com/hyperledger-identus/mediator/issues/139)) ([c788335](https://github.com/hyperledger-identus/mediator/commit/c7883350f7e5b8070330010f8f299d4c0f32e7ee))
...
* Annotate Headers & Update zio-http to version 3.0.0-RC2 ([#106](https://github.com/hyperledger-identus/mediator/issues/106)) ([aa19f0a](https://github.com/hyperledger-identus/mediator/commit/aa19f0a1b9a547a562139b7c91373c1d84ddfa39))
...
* add MediatorBuildInfo & /did and /version endpoints ([#120](https://github.com/hyperledger-identus/mediator/issues/120)) ([4445e1f](https://github.com/hyperledger-identus/mediator/commit/4445e1f3db5011264e2831cf12d1ed183406447d))
* add tag latest to the mediator docker image ([#118](https://github.com/hyperledger-identus/mediator/issues/118)) ([020f2cd](https://github.com/hyperledger-identus/mediator/commit/020f2cdff5e8e32ac8f880b7a87f0e0239c5ce34))
* Added test for executor and problem reports  ([#117](https://github.com/hyperledger-identus/mediator/issues/117)) ([ce05d5a](https://github.com/hyperledger-identus/mediator/commit/ce05d5a0894ae0cee1eaba89bd5834182800e9ef))
...
* mongodb init script updated infrastructure mongodb yaml ([#94](https://github.com/hyperledger-identus/mediator/issues/94)) ([d9cc42a](https://github.com/hyperledger-identus/mediator/commit/d9cc42a319d505e37b5a9cdbe47802283537adaf))
* set default endpoint to localhost ([#102](https://github.com/hyperledger-identus/mediator/issues/102)) ([de8b702](https://github.com/hyperledger-identus/mediator/commit/de8b702e6fa70a6a8f5ee311c7a236f45d328c04))
...
* Store outbound messages ([#84](https://github.com/hyperledger-identus/mediator/issues/84)) ([3576656](https://github.com/hyperledger-identus/mediator/commit/3576656844834d0ecc6365b912dda6f383936d5f))
...
* reply condition check ReturnRoute ([#88](https://github.com/hyperledger-identus/mediator/issues/88)) ([68c86c8](https://github.com/hyperledger-identus/mediator/commit/68c86c871b8300e08cadbaf64284dc4d0e4abb3f))
...
* mediator test ([#71](https://github.com/hyperledger-identus/mediator/issues/71)) ([7572dcc](https://github.com/hyperledger-identus/mediator/commit/7572dcc5bbd8ec07ee452bfc044863e50324c909))
...
* add helm-chart for mediator ([#64](https://github.com/hyperledger-identus/mediator/issues/64)) ([52e5d3b](https://github.com/hyperledger-identus/mediator/commit/52e5d3bf031895336279d6981016bada9ce32eaf)), closes [#61](https://github.com/hyperledger-identus/mediator/issues/61) [#63](https://github.com/hyperledger-identus/mediator/issues/63)
* helm-chart appVersion bump and addtional fixes ([#67](https://github.com/hyperledger-identus/mediator/issues/67)) ([3ccbe3e](https://github.com/hyperledger-identus/mediator/commit/3ccbe3ed093c7f22dbd4b934e9d9ce8488cbd302))
...
* mediator ATL-4883 pickup status message to sync reply ([#59](https://github.com/hyperledger-identus/mediator/issues/59)) ([c0b6de0](https://github.com/hyperledger-identus/mediator/commit/c0b6de0f4fe4702641ff9e8a371b3aff3cd74e1f))
...
* Better error handling for connection refused ([#47](https://github.com/hyperledger-identus/mediator/issues/47)) ([429940e](https://github.com/hyperledger-identus/mediator/commit/429940e2ef6807017c4e4ef156432e843c5cdccc))
* Do not send response errors to the caller ([#50](https://github.com/hyperledger-identus/mediator/issues/50)) ([60ee3ef](https://github.com/hyperledger-identus/mediator/commit/60ee3ef8e4342fb5fa69501502abdd739c55e22a))
...
* dynamic DID on the web page ([#40](https://github.com/hyperledger-identus/mediator/issues/40)) ([0949a19](https://github.com/hyperledger-identus/mediator/commit/0949a191679caf91575a7d27d69ad1ced89577cd))
...
* disabled documentation generation ([#24](https://github.com/hyperledger-identus/mediator/issues/24)) ([8a2a6ad](https://github.com/hyperledger-identus/mediator/commit/8a2a6adf712e17caecdbd2b2f06ff5edf68e0a03))
* field name routing_did in keylist response body ([#22](https://github.com/hyperledger-identus/mediator/issues/22)) ([f61f114](https://github.com/hyperledger-identus/mediator/commit/f61f1148f033fa3587ab9787bb06428ba14cf6ab))
* Fix release job (add more ram) ([#32](https://github.com/hyperledger-identus/mediator/issues/32)) ([97ab05a](https://github.com/hyperledger-identus/mediator/commit/97ab05a943053dce1d789d6aac6d736517c2bfee))
* make content-type header case insensitive & remove support for ws ([#7](https://github.com/hyperledger-identus/mediator/issues/7)) ([d4a169a](https://github.com/hyperledger-identus/mediator/commit/d4a169a9ef16b4677bfb31b8785dc79474d9062a))
...
* Add config from application.conf and docker compose and an example ([#10](https://github.com/hyperledger-identus/mediator/issues/10)) ([2037377](https://github.com/hyperledger-identus/mediator/commit/203737789a53c9a22d0450564a988518c61f1fc0))
* Add Storage ([#8](https://github.com/hyperledger-identus/mediator/issues/8)) ([881e66e](https://github.com/hyperledger-identus/mediator/commit/881e66e9b6d0bbfc49cb0d8ec63583c802257a40))
* mediator  added more logs and associated message Hash and structured logging ([#16](https://github.com/hyperledger-identus/mediator/issues/16)) ([119b637](https://github.com/hyperledger-identus/mediator/commit/119b6372ab51ece6ded913b93ea7a607cde9acfe))
* mediator added test for storage layer ([#13](https://github.com/hyperledger-identus/mediator/issues/13)) ([25728b6](https://github.com/hyperledger-identus/mediator/commit/25728b6d8aad7cc2143844bad10e2e27bdf5d25f))
* mediator rename package and organise the packages ([#12](https://github.com/hyperledger-identus/mediator/issues/12)) ([8ea2aac](https://github.com/hyperledger-identus/mediator/commit/8ea2aaccadf515fe6a7d300c0250d70e38fb3b18))
* new a Webapp to show the QR Code  ([#21](https://github.com/hyperledger-identus/mediator/issues/21)) ([9af0a87](https://github.com/hyperledger-identus/mediator/commit/9af0a87cab64b62cb663bbe5bfedf730d09d50de))
* process KeylistQuery and return Keylist ([#30](https://github.com/hyperledger-identus/mediator/issues/30)) ([c5fb175](https://github.com/hyperledger-identus/mediator/commit/c5fb17584dc9d464e49589473ee3fe185db0b58f))
* reply to StatusRequest ([#26](https://github.com/hyperledger-identus/mediator/issues/26)) ([28ee891](https://github.com/hyperledger-identus/mediator/commit/28ee891999f5174356f245d46812526b044b789b))
...
* Hardcode the atala prism did identity ([#9](https://github.com/hyperledger-identus/mediator/issues/9)) ([7984eea](https://github.com/hyperledger-identus/mediator/commit/7984eeacaf6bbd70a58356c3df74ce87b75485bd))
...
* Add docker config to build.sbt ([#5](https://github.com/hyperledger-identus/mediator/issues/5)) ([c7418d0](https://github.com/hyperledger-identus/mediator/commit/c7418d0b0f17979d20af3ed6d7c8609ec2056c13))
* mediator initial release ([#4](https://github.com/hyperledger-identus/mediator/issues/4)) ([8499bf2](https://github.com/hyperledger-identus/mediator/commit/8499bf24d4d94ee30fb917501de4364d2cd6c96e))
